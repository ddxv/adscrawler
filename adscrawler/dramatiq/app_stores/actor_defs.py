...
@dramatiq.actor(
    queue_name=QUEUE_GOOGLE_1, max_retries=3, min_backoff=15_000, time_limit=3_200_000
)
...
@dramatiq.actor(
    queue_name=QUEUE_APPLE_1, max_retries=3, min_backoff=15_000, time_limit=3_200_000
)
...
@dramatiq.actor(
    queue_name=QUEUE_GOOGLE_2, max_retries=3, min_backoff=15_000, time_limit=3_200_000
)
...
@dramatiq.actor(
    queue_name=QUEUE_APPLE_2, max_retries=3, min_backoff=15_000, time_limit=3_200_000
)

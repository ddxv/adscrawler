...
\restrict zwfL9NOZo98O4LNJziPp1vjQkqfZxw0Msc9Uh5zp1QHQcXYZbMV02oD11qxAQMg
...
CREATE INDEX store_apps_name_idx ON public.store_apps USING gin (
...
CREATE INDEX textsearch_generated_idx ON public.store_apps USING gin (
...
ALTER TABLE ONLY public.store_apps
ADD CONSTRAINT store_apps_fk_03 FOREIGN KEY (
    crawl_result
...
ALTER TABLE ONLY public.store_apps
ADD CONSTRAINT store_apps_fk_1 FOREIGN KEY (
    developer
...
\unrestrict zwfL9NOZo98O4LNJziPp1vjQkqfZxw0Msc9Uh5zp1QHQcXYZbMV02oD11qxAQMg

...
\restrict SJTImwrqe6pKIrp8PG7YwSE4m5UxJlxyrwlb4he4EVNjGLmVd6alZPZitCDnPtB
...
CREATE INDEX dev_textsearch_generated_idx ON public.developers USING gin (
...
CREATE INDEX developers_developer_id_idx ON public.developers USING btree (
    developer_id
);
...
CREATE INDEX developers_name_idx ON public.developers USING gin (
...
\unrestrict SJTImwrqe6pKIrp8PG7YwSE4m5UxJlxyrwlb4he4EVNjGLmVd6alZPZitCDnPtB

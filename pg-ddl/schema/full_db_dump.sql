...
\restrict uWpgOdCt3b123EPnL2U06TGIwdgxbLlayheP26zgeVkFp6hlDWWiFLh3c0M2H4G
...
--
-- Name: companies_overview_reroll; Type: MATERIALIZED VIEW; Schema: frontend; Owner: postgres
--

CREATE MATERIALIZED VIEW frontend.companies_overview_reroll AS
 WITH domain_base AS (
         SELECT d.id AS domain_id,
            d.domain_name AS company_domain,
            cac.company_id,
...
ALTER MATERIALIZED VIEW frontend.companies_overview_reroll OWNER TO postgres;
...
\unrestrict uWpgOdCt3b123EPnL2U06TGIwdgxbLlayheP26zgeVkFp6hlDWWiFLh3c0M2H4G

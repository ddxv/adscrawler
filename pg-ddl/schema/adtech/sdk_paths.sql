...
\restrict V7Bf0ksVuHcMgsoPaR1RPMgJNbhHS50B6wE2x3ToM9nWzVGpZ0ZxJd3TERebIGx
...
CREATE INDEX sdk_path_pattern_idx ON adtech.sdk_paths USING btree (
    path_pattern
);
...
ALTER TABLE ONLY adtech.sdk_paths
ADD CONSTRAINT sdk_paths_sdk_id_fkey FOREIGN KEY (
    sdk_id
...
\unrestrict V7Bf0ksVuHcMgsoPaR1RPMgJNbhHS50B6wE2x3ToM9nWzVGpZ0ZxJd3TERebIGx

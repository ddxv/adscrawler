...
ALTER TABLE public.store_apps_country_history ADD CONSTRAINT fk_country FOREIGN KEY (country_id) REFERENCES public.countries(id);
ALTER TABLE public.store_apps_country_history ADD CONSTRAINT store_apps_country_history_app_fk FOREIGN KEY (store_app) REFERENCES public.store_apps(id);
